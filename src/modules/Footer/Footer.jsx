				...
				<div className={style.footerWrapper}>
					...
					<div className={style.timetAdresWrapper}>
						<div className={style.timetWrapper}>
							...
							<p className={style.contact}>пн-пт 16:00 - 22:00 сб-нд 16:00 - 18:00</p>
						</div>
					...
					<div>
						<div className={style.socialWrapper}>
							<Link href='https://www.facebook.com/HzPubCraftbeer' target='_blank'>
								{/* <svg className={style.socialItem} width='40' height='40'>
									<use xlinkHref={`${sprite}#facebook`}></use>
								</svg> */}
							</Link>
							<Link href='https://www.instagram.com/craftbeer_pub_2020/' target='_blank'>
								{/* <svg className={style.socialItem} width='40' height='40'>
